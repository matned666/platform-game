...
public class ModelImpl implements Model {
    ...
    public void addNewDrawingArea(double width, double height) {
        activeCanvasModel = new CanvasModel(width, height, this, controller);
    }
    ...
    @Override
    public void onKeyPressed(KeyMap keyMap, boolean mod1, boolean mod2) {
        activeCanvasModel.onKeyPressed(keyMap, mod1, mod2);
    }

    @Override
    public void onKeyReleased(KeyMap key) {
        activeCanvasModel.onKeyReleased(key);
    }
